...
public class ServiceManager4Chat {

    private static final boolean DEBUG = MPEnv.DEBUG;

    private static final String TAG = ServiceManager4Chat.class.getSimpleName();

    private static final Uri SERVICE_MANAGER_URI;

    static final String SERVICE_MANAGER_KEY = ServiceManagerProvider4Chat.PATH_SERVICE_PROVIDER;

    static {
        SERVICE_MANAGER_URI = Uri.parse("content://"
                + ServiceManagerProvider4Chat.AUTHORITY + "/"
                + ServiceManagerProvider4Chat.PATH_SERVICE_PROVIDER);
    }
    ...
    private static class ServiceManagerWrapper implements
        ...
        private synchronized IServiceManagerService queryService() {
            IServiceManagerService service = null;
        ...
        public void binderDied() {
            ...
            mServerManagerImpl = null;
            ServiceList.clearCache();
            /*
